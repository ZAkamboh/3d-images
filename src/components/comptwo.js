...
<div class="colors">
<div class="color" style={{backgroundColor:"#e1e851"}} data-hex="#e1e851"></div>
<div class="color" style={{backgroundColor:"#8cd147"}}  data-hex="#8cd147"></div>
<div class="color" style={{backgroundColor:"#4a9ccf"}}  data-hex="#4a9ccf"></div>
<div class="color" style={{backgroundColor:"#661f45"}}  data-hex="#661f45"></div>
<div class="color" style={{backgroundColor:"#1e2024"}}  data-hex="#1e2024"></div>
</div>
</div>
    );
  }
